...
export default function ItemCard({ item }: ItemCardProps) {
  ...
  const { id, name, price, image, description, available } = item;
    ...
    >
      ...
      <div className="relative aspect-square w-full bg-slate-50 overflow-hidden">
        ...
        <WishlistButton
          productId={id}
          productName={name}
          category={typeof item.category === 'string' ? item.category : item.category?.name || item.categorySlug}
