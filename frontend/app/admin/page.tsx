...
export default function AdminDashboardPage() {
  ...
  const dashboardQuery = useQuery({
    ...
    queryFn: async () => {
      const [itemsRes, ordersRes, blogsRes, usersRes] = await Promise.all([
      ...
      const allUsers = (usersRes.success && usersRes.data) ? usersRes.data : [];
  ...
  const data = dashboardQuery.data || { productsCount: 0, ordersData: [], blogsCount: 0, usersCount: 0 };
